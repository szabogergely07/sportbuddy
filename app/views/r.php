...
<div id="sign-up-form" class="sign-form section-separator">
                    ...
                    <form method="post" class="single-form" action="sportbuddy/createuser">
                        ...
                        <div class="col-xs-12 fields">
                            <!-- First Name -->
                            <input name="first_name" class="form-control" type="text" placeholder="First Name*" value="<?= @$first_name ?>" required="" id="inputWarning1">
                        ...
                        <div class="col-xs-12">
                            <!-- Email -->
                            <input name="birthday" type="" class="contact-first-name form-control <?= Val::valDate($birthday) ? '' : $invalid ?>" placeholder="Birthday*" value="<?= $birthday ?>" required="">
