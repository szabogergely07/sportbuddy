...
<div id="signup-form">
    ...
    <div class="form-group row has-error has-feedback">
        ...
        <div class="col-xs-12 col-md-4 col-md-offset-4 fields">
            <!-- First Name -->
            <input name="first_name" class="contact-first-name form-control" type="text" placeholder="First Name*" value="<?= $unit['first_name'] ?>" required="" id="inputWarning1">
        </div>
    </div>
    ...
    <div class="form-group row has-error has-feedback">
        <div class="col-xs-12 col-md-4 col-md-offset-4 fields">
            <!-- Last Name -->
            <input name="last_name" class="contact-last-name form-control " type="text" placeholder="Last Name*" value="<?= $unit['last_name'] ?>" required="">
    ...
    <div class="form-group row has-error has-feedback">
        <div class="col-xs-12 col-md-4 col-md-offset-4">
            <!-- Email -->
            <input name="email" class="contact-email form-control" type="email" placeholder="Email*" value="<?= $unit['email'] ?>" required="">
    ...
    <div class="form-group row has-error has-feedback">
        <div class="col-xs-12 col-md-4 col-md-offset-4">
            <!-- Email -->
            <input name="birthday" type="date" class="contact-first-name form-control " placeholder="Birthday*" value="<?= $unit['birthday'] ?>" required="">
